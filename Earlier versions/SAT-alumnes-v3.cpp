...
/*
v3 - abans:						preprocessing -> pure-literal, (subsumption, self-subsuming resolution)
v4 - seleccio proxim:			variable state independent decaying sum
v5 - conflicte + backtrack:		conflict-driven clause learning + periodic purges
v6 - evitar bloqueigs:			rapid random restarts
*/
